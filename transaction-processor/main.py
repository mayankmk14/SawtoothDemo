...
#         print('Error in starting the processor')
#         print(e)
#     finally:
#         processor.stop()
...
DISTRIBUTION_NAME = 'sawtooth-CUSTOM-BANK-TP'
tp_config_name='Bank'
...
def main(args=None):
    ...
    try:
        ...
        LOGGER.error("At Handler")
        handler = BankingTransaction()
        LOGGER.error("Banking Handler")
        processor.add_handler(handler)
        LOGGER.error("Processor Starting")
        processor.start()
